...
2. **Apply project skills before writing**
   ...
   - `programs-network-mocking` — for programs API edge cases (500/503/timeout/empty/malformed, plus 401/403/404/3xx): `page.route`, observe real UI copy first, POMs only, one tag per test.
